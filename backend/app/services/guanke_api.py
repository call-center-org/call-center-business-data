...
class GuankeAPI:
        ...
        while current_start <= end:
            ...
            while True:
                ...
                if data.get("code") == 200:
                    ...
                    print(
                        f"    第{page}页: 获取{len(page_data)}条 (总计: {len(all_records)}/{total_count})"
                    )
    ...
    def get_agent_statistics(self, start_time, end_time, query_type=20):
        """
        获取统计数据（任务维度或其他维度）
        ...
        返回：
            [
                {
                    "user_id": 任务ID (query_type=20时),
                    "callout_number": 外呼数量,
                    "called_number": 接通数量,
                    "connected_rate": 接通率,
                    "success_number": 成功数,
                    "intention_number": 意向数量1,
                    "intention_number2": 意向数量2,
                    ...
                }
            ]
        """
        ...
        url = f"{self.base_url}/extension/agent/stat"
            ...
            if result.get("code") == 200:
                ...
                return {
                    ...
                    "data": {
                        ...
                        "average": result.get("data", {}).get("average", {}),
                    },
                }
            else:
                return result
